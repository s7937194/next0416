    ...
    return ( 
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost  text-xl">survivor</a>
            </div>
            ...
            <div className="navbar-end">
                { theme =='luxury' && 
                <div className=" border-[3px] rounded-lg mx-6 p-2" onClick={() => setTheme('bumblebee')}>
                ...
                { theme =='bumblebee' &&
                <div className=" border-[3px] rounded-lg mx-6 p-2" onClick={() => setTheme('luxury')}>
                        <svg  className="fill-current w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a onClick={initApp} className="btn btn-primary ">{address}</a>
            </div>
        </div>
