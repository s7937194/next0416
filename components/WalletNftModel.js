...
const WalletNftModel = () => {
    ...
    return ( 
        <div>
            <input type="checkbox" id="WalletNftModel" className="modal-toggle"/>
            
            <div className="modal bg-black bg-opacity-80" for="WalletNftModel">
                    ...
                    <div className="px-md">
                        <div className="flex gap-x-md mb-8" >
                            ...
                            <div className="flex justify-between items-start ml-6 flex-col">
                                ...
                                <label for="my-modal" className="btn btn-primary rounded-full text-xl px-10 modal-button capitalize">
                                        List NFT
                                </label>
                                ...
                                <div className="modal">
                                        <div className="modal-box">
                                            <div className="form-control w-full  flex justify-center">
                                                    ...
                                                    <div>
                                                        <input type="number" placeholder="1" className="input input-bordered w-[60%] "/>
                                                    </div>
                                            ...
                                            <div className="modal-action flex justify-center">
                                                    <label  className="btn btn-primary capitalize ">List</label>
                                                    <label for="my-modal" className="btn capitalize ">Cancel</label>
                                            </div>
                                        </div>
                                </div>
