...
const RecentModel = ({src="", tokenId="", name="", rarity="Common"}) => {
    return ( 
        <div>  
            <input type="checkbox" id={"recentModel_"+tokenId} className="modal-toggle"/>
            <label htmlFor={"recentModel_"+tokenId} className="modal bg-black bg-opacity-80">
                <label className="modal-box w-4/12 max-w-5xl" htmlFor="">
                    <div className="flex justify-between items-center pb-2">   
                        ...
                        <label htmlFor={"recentModel_"+tokenId} >
